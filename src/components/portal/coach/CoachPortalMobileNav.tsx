...
/**
 * Accessible mobile drawer for the coach portal — same contract as the
 * Student and Parent Portal drawers (aria-expanded/aria-controls, focus
 * moves to the first link on open, Escape closes and restores focus,
 * body scroll lock). Duplicated rather than extracted into a shared
 * primitive — same rationale as the Parent Portal's drawer: avoids a
 * risky refactor of already-shipped, validated code for a small amount
 * of reuse.
 */
  ...
  return (
    <div className="lg:hidden">
      <button
        ...
        aria-expanded={open}
        aria-controls="coach-portal-mobile-drawer"
        ...
        <div className="fixed inset-0 z-50" role="presentation">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <span className="text-body-sm font-medium text-muted-foreground">Coach Portal</span>
              <button
                type="button"
                onClick={close}
